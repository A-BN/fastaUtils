...
plot_contigs <- function(contig_sizes){
  ...
  ggplot2::ggplot(data = contig_sizes_df)+
    ...
    ggplot2::geom_area(mapping = ggplot2::aes(x = n, y = cumsum), colour = "black", fill = ggplot2::alpha("blue2", 0.3))+
    ggplot2::scale_x_log10()+
    # ggplot2::scale_fill_manual(values = c("chartreuse"))+
    # ggplot2::scale_colour_manual(values = alpha(c("green")), 0.3)+
